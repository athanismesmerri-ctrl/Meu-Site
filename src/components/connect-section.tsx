...
export function ConnectSection() {
  ...
  const contacts = [
    { labelKey: "siteLabel" as const, href: "https://www.famoors.com", external: true, icon: contactIcons.site },
    { labelKey: "emailLabel" as const, href: "mailto:info@athanismesmerri.com", external: false, icon: contactIcons.email },
    { labelKey: "whatsappLabel" as const, href: "https://wa.me/351925126637", external: true, icon: contactIcons.whatsapp },
  ];
