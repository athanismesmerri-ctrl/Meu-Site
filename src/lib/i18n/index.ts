...
const pt: T = {
  ...
  hero: {
    label: 'Autora · Criadora · Empresária',
  ...
  about: {
    title: 'Sobre Athanís',
    p1: 'Sou Athanís Mesmerri — escritora, parapsicóloga e empresária. A minha presença move-se entre a escrita autoral, a pesquisa da mente humana e a fundação de projetos que transformam pessoas e marcas.',
    p2Pre: 'Fundadora e CEO da ',
    p2Post: ' — desenvolvo produtos digitais, terapias energéticas, projetos editoriais e soluções B2B que unem comportamento, consciência e estratégia.',
    p3: 'A escrita é um eixo central da minha marca. Publiquei múltiplos livros na Amazon em ficção, poesia metafísica e não-ficção — com uma voz autoral própria, entre o filosófico e o introspectivo.',
    p4Pre: 'Sou criadora do ',
    p4Post: ' e idealizadora do Institut Pathé na Europa — metodologias que integram neurociência, hipnose clínica, parapsicologia e regulação neuroemocional integrativa.',
    p5: '',
    p6: '',
  },
  results: {
